...
typename sb_handle_t::event_t inline _gbmv(
  ...
  if (trn == transpose_type::Normal) {
    return blas::internal::_gbmv_impl<32, transpose_type::Normal>(
        sb_handle, _M, _N, _KL, _KU, _alpha, _mA, _lda, _vx, _incx, _beta, _vy,
        _incy);
  } else {
...
template <uplo_type uplo, typename sb_handle_t, typename index_t,
          typename element_t, typename container_t0, typename container_t1,
          typename increment_t, typename container_t2>
typename sb_handle_t::event_t inline _sbmv(sb_handle_t& sb_handle, index_t _N,
  ...
  if (uplo == uplo_type::Upper) {
    return blas::internal::_sbmv_impl<32, uplo_type::Upper>(
        sb_handle, _N, _K, _alpha, _mA, _lda, _vx, _incx, _beta, _vy, _incy);
  } else {
    return blas::internal::_sbmv_impl<32, uplo_type::Lower>(
        sb_handle, _N, _K, _alpha, _mA, _lda, _vx, _incx, _beta, _vy, _incy);
  }
}
